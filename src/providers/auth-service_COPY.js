...
var AuthService = (function () {
    ...
    AuthService.prototype.postIt2 = function () {
        var params = JSON.stringify({ var1: 'test', var2: 325 });
        var headers = new Headers();
        headers.append('Content-type', 'application/x-www-form-urlencoded');
        /******* NEW ********/
        // let headers = new Headers({ 'Content-Type': 'application/json' });
        // let options = new RequestOptions({ headers: headers });
        return this.http.post('http://alexinformationtech.com/post.php', params, { headers: headers }).map(function (res) { return res.json(); });
        // return this.http.post('http://alexinformationtech.com/post.php', params, options).map((res) => {res.json()});
    };
    AuthService.prototype.postIt = function () {
    ...
    AuthService.prototype.donee = function () {
        var headers = new Headers();
        headers.append('GEEVLY-API-KEY', '8a04542c78cd8ded94df700b2f73e49f33bc613f');
        /******* NEW ********/
        // let headers = new Headers({ 'Content-Type': 'application/json' });
        // let options = new RequestOptions({ headers: headers });
        return this.http.get('https://api.geevly.org/api_donee/donees', { headers: headers }).map(function (res) { return res.json(); });
        // return this.http.post('http://alexinformationtech.com/post.php', params, options).map((res) => {res.json()});
    };
    return AuthService;
}());
...
export { AuthService };
//# sourceMappingURL=auth-service_COPY.js.map